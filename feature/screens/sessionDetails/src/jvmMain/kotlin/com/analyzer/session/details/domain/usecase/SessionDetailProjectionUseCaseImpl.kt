...
class SessionDetailProjectionUseCaseImpl(
    @param:Default
    private val default: CoroutineDispatcher,
) : SessionDetailProjectionUseCase {

    override suspend fun project(dataset: SessionDetailDataset, query: SessionDetailQuery): SessionDetailProjection =
        withContext(default) {
