...
import com.analyzer.trackmap.presentation.TrackMapLibraryScreen
...
class TrackMapLibraryEntry : RouteEntryBuilder {

    override fun NavigationEntryBuilder.build() {
        entry(Route.SettingsRoot.DevTrackMapLibrary) {
            TrackMapLibraryScreen()
        }
    }
}
