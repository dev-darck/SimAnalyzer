...
**Compose Multiplatform (KMP) **desktop-only** project.**
...
## Modules
- `:build-logic:convention` - Common setup for all modules in the project
- `:composeApp:desktop` — Compose Desktop app (KMP + Compose)
