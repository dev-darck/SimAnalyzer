...
internal data class StoragePayloadDescriptor(val storagePayloadType: String, val storagePayloadSize: Int)

internal data class EncodedFramePayload(val storagePayloadType: String, val storagePayload: ByteArray)
