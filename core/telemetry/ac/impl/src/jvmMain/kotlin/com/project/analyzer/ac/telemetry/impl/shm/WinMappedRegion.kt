...
internal class WinMappedRegion(private val mappingName: String) : Closeable {
    ...
    fun openReadOnly(): Pointer? {
        view?.let { return it }

        val h = kernel32.OpenFileMapping(WinNT.FILE_MAP_READ, false, mappingName)
            ?: return null

        val p = kernel32.MapViewOfFile(h, WinNT.FILE_MAP_READ, 0, 0, 0)
            ?: run {
