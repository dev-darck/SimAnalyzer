...
public data class CarFrame(
    ...
    val displaySpeedMph: Int? = null,
    val displaySpeedMs: Int? = null,
    val steeringDegrees: Int? = null,
    val odometerKm: Long? = null,
    val drivingTimeSec: Long? = null,
    val ffMultiplier: Float? = null,
    val carLocation: String? = null,
    val isWrongWay: Boolean? = null,
    val specialLightsStage: Int? = null,
    val cockpitLightStage: Int? = null,
    val warningLightsOn: Boolean? = null,
    val areHeadlightsVisible: Boolean? = null,
    val displayPageIndices: List<Int> = emptyList(),
    val performanceMeter: Float? = null,
)
